...
/**
 * Created by Kirill on 21.02.2017.
 */
...
public class Camera2VideoFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mChronometer = (Chronometer) view.findViewById(R.id.chronometer2);
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            mNextVideoAbsolutePath = getVideoFilePath(activity.getApplicationContext());
        }
...
//        File mVideoFolder = new File(movieFile, "camera2VideoImage");
//        if(!mVideoFolder.exists()) {
//            mVideoFolder.mkdirs();
//        }
//        try {
//            return File.createTempFile("Video",".mp4",mVideoFolder).getAbsolutePath();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//       return movieFile.getAbsolutePath()+"/name.mp4";
    }
